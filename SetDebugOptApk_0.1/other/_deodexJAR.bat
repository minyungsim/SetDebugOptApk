...
java -Xmx%heapy%m -jar "./other/baksmali-%smaliversion%.jar" -a %api% -d framework -d place-odex-here-to-deodex -x "place-odex-here-to-deodex/%~n1.odex" -o deodex 
if errorlevel 1 goto error
echo Copying "classes.dex" to %~n1.jar...
java -Xmx%heapy%m -jar "./other/smali-%smaliversion%.jar" -a %api% deodex -o classes.dex
if errorlevel 1 goto error
%~dp0\7za u -tzip "place-odex-here-to-deodex\%~n1.jar" classes.dex %2
:: cleanup
echo Cleaning up...
