...
%~dp0\7za u -tzip "%~n1.apk" "classes.dex" %2
cd ..
%~dp0\zipalign -f 4 "place-odex-here-to-deodex\%~n1.apk" "place-odex-here-to-deodex\algin_%~n1.apk"
del /q "place-odex-here-to-deodex\%~n1.apk"
rename ".\place-odex-here-to-deodex\algin_%~n1.apk" "%~n1.apk"
:: cleanup
echo Cleaning up...
